...
| 04 | dbt transform & star schema (staging → dims/fact → aggregates) via Cosmos | [04-dbt-transformation-star-schema.md](04-dbt-transformation-star-schema.md) | Draft — awaiting approval |
